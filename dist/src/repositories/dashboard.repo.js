...
export const countClassesByTeacherId = async (teacherId) => {
 ...
 */
export const countDistinctStudentsByTeacherId = async (teacherId) => {
 ...
 */
export const countPendingEssaySubmissionsByTeacherId = async (teacherId) => {
    const classes = await prisma.classes.findMany({
        where: { teacherId },
        select: { classId: true },
    });
...
export const findClassSummariesByTeacherId = async (teacherId, limit = 5) => {
...
export const findPendingEssaySubmissions = async (teacherId, limit = 10) => {
    const classes = await prisma.classes.findMany({
        where: { teacherId },
        select: { classId: true },
    });
...
export const findUpcomingAssignmentsByTeacherId = async (teacherId, withinDays = 7, limit = 10) => {
    const now = new Date();
...
export const findRecentSubmissionsByTeacherId = async (teacherId, limit = 10) => {
    const classes = await prisma.classes.findMany({
        where: { teacherId },
        select: { classId: true },
    });
